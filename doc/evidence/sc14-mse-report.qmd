...
date: now
date-format: "[Draft —] D MMMM YYYY, h:mm A z"
language:
...
::: {.content-visible when-format="html"}
```{=html}
<div id="sc14-draft-stamp" class="draft-stamp" aria-label="Report draft timestamp"></div>
<script>
(() => {
  const source = document.querySelector("#title-block-header .date");
  const target = document.getElementById("sc14-draft-stamp");
