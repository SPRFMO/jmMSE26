...
::: {.callout-warning}
## Incomplete results — 30 July 2026

The results in this report are incomplete and provisional as of 30 July 2026.
The current figures and tables use the restored 100-sample candidate results.
Please check back after all CMPs have been tuned and evaluated against the 500
posterior samples and the report outputs have been rebuilt and validated.
:::
...
to the CMP-specific healthy-rule condition. These runs did **not** retain the
annual TAC-change limits, so they do not isolate banking and borrowing from the
effect of removing those limits.
