...
marginal 5th--95th percentiles. The reference and robustness comparisons are
shown in @fig-catch-vbmsy-reference and @fig-catch-vbmsy-robustness,
respectively.
...
2041--2050, with the same aggregation. The corresponding reference and
robustness comparisons are shown in @fig-catch-vb2025-reference and
@fig-catch-vb2025-robustness.
