...
with the post-workshop analysis summarized in the 24 July task-team meeting
report and 25 July progress presentation. The sources have different roles:
...
Dark purple means higher relative preference and white means lower relative
preference. Higher
...
![Reference-OM candidate performance quilt for the eight naming-convention variants. Cell labels are median 2041--2050 values. Dark purple indicates higher relative preference and white indicates lower relative preference within each metric.](../figures/candidates/candidate_quilt_reference.png){#fig-candidate-quilt fig-align="center" width="95%"}
...
It converts quilt badness to a 0--100 benefit score, records the preferred
